...
#ifndef VERILATED_VDESIGN_2_TOP_H_
#define VERILATED_VDESIGN_2_TOP_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class Vdesign_2_top__Syms;
class Vdesign_2_top___024root;
class VerilatedVcdC;
class Vdesign_2_top_design_2_top;


// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vdesign_2_top VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vdesign_2_top_design_2_top* const design_2_top;

    // Root instance pointer to allow access to model internals,
    // including inlined /* verilator public_flat_* */ items.
    Vdesign_2_top___024root* const rootp;
    ...
    explicit Vdesign_2_top(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vdesign_2_top(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vdesign_2_top();
  private:
